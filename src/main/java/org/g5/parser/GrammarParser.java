...
public class GrammarParser extends Parser {
	...
	public static final int
		MULTI_LINE_COMMENT=1, SINGLE_COMMENT=2, FLOAT=3, INT=4, ID=5, NEWLINE=6, 
		DELIMITER=7, OPEN_BRACK=8, CLOSE_BRACK=9, COMMA=10, ASSIGN=11, OPEN_PAREN=12, 
		CLOSED_PAREN=13, SIGMOID=14, RELU=15, TANH=16, ARROW=17, OPEN_SQUARE=18, 
		CLOSED_SQUARE=19, BREAK=20, RETURN=21, IF=22, ELSE=23, LOOP=24, AND=25, 
		OR=26, NEQ=27, EQ=28, GEQ=29, LEQ=30, GE=31, LE=32, MINUS=33, PLUS=34, 
		TIMES=35, DIV=36;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "MULTI_LINE_COMMENT", "SINGLE_COMMENT", "FLOAT", "INT", "ID", "NEWLINE", 
			...
			"LEQ", "GE", "LE", "MINUS", "PLUS", "TIMES", "DIV"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 24498232L) != 0)) {
				{
				{
				setState(36);
				statement();
	...
	public final Function_callContext function_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 380984L) != 0)) {
				{
				setState(104);
				expression(0);
				}
